...
dash.register_page(__name__, path="/theme/cyborg", name="Theme: Cyborg")

# Cyborg — dark, high-contrast, sci-fi Bootstrap theme (Bootswatch)
CYBORG_CSS = "https://cdn.jsdelivr.net/npm/bootswatch@5.3.3/dist/cyborg/bootstrap.min.css"
...
layout = html.Div([
    html.Link(rel="stylesheet", href=CYBORG_CSS),

    dbc.Container([
        dbc.Row(dbc.Col([
            html.H1("Cyborg Theme", className="mb-1"),
            html.P(
                "Bootswatch Cyborg — dark, high-contrast, bold. Good for tech-heavy applications.",
