...
dash.register_page(__name__, path="/theme/flatly", name="Theme: Flatly")

# Flatly — clean, corporate, light Bootstrap theme (Bootswatch)
...
layout = html.Div([
    # Override stylesheet for this page only
    html.Link(rel="stylesheet", href=FLATLY_CSS),

    dbc.Container([
        dbc.Row(dbc.Col([
            html.H1("Flatly Theme", className="mb-1"),
            html.P(
                "Bootswatch Flatly — clean, corporate, light. Good for professional internal tools.",
